...
class MainActivity : AppCompatActivity() {
    ...
    private val cheeseIpsum: MyData = MyData("Cheese Ipsum", "I love cheese, especially goat macaroni cheese. Danish fontina pecorino bocconcini stinking bishop port-salut cheesy feet blue castello red leicester. Caerphilly smelly cheese dolcelatte edam port-salut hard cheese fromage frais rubber cheese. Everyone loves cheddar airedale fromage frais fromage frais st. agur blue cheese swiss croque monsieur. Monterey jack pepper jack.\n" +
